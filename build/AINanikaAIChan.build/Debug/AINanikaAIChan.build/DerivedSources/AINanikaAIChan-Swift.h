...
#ifndef AINANIKAAICHAN_SWIFT_H
#define AINANIKAAICHAN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AINanikaAIChan",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC14AINanikaAIChan11AppDelegate")
...
@class NSCoder;
@class NSWindow;
SWIFT_CLASS("_TtC14AINanikaAIChan25CharacterWindowController")
...
@class NSEvent;
@interface CharacterWindowController (SWIFT_EXTENSION(AINanikaAIChan))
